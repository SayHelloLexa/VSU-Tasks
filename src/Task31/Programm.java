...
public class Programm {
    ...
    public static final HorizontalParabola2 P2 = new HorizontalParabola2(-2, -5, -0.125);
    public static final VerticalParabola P3 = new VerticalParabola(4, 5, -0.25);
    ...
    public static SimpleColor getColor(double x, double y) {
        if(!P3.isPointDUpOfParabola(x, y) && L.isPointAboveLine(x, y)){
        ...
        if(L.isPointAboveLine(x, y) && y < 2 && x > 7){
            return SimpleColor.GREEN;
        }
